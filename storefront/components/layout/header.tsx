...
import { Search, ShoppingBag, User, Menu, X, LogIn, Car } from 'lucide-react'
        ...
        <div className="container-custom">
          <div className="flex h-16 items-center justify-between gap-4">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-heading text-xl font-semibold tracking-tight" style={{ color: 'var(--brand-secondary)' }}>
                RevRacers
              </span>
            </Link>
          ...
          >
            <div className="flex items-center justify-between p-4 border-b">
              <div className="flex items-center gap-2">
                ...
                <span className="font-heading text-lg font-semibold" style={{ color: 'var(--brand-secondary)' }}>
                  RevRacers
                </span>
              </div>
              <button
            ...
            <nav className="p-4 space-y-1">
              <Link
                href="/products"
                onClick={() => setIsMobileMenuOpen(false)}
                className="block py-3 text-lg tracking-wide border-b border-border/50 font-medium"
                prefetch={true}
              >
                Shop All
              </Link>
